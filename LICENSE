...
Copyright (c) 2025 Curso de Python de freeCodeCamp
...
el Software sin restricciones, incluyendo sin limitación los derechos de usar, copiar, modificar,
...
AUTORES O TITULARES DEL COPYRIGHT SER
